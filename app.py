...
with pestanas[0]:
    ...
    st.text("<h2 style='text-align: center;'>Seleccione la distribución que desea simular en las pestañas superiores. Ajuste el tamaño de la muestra en la barra lateral para ver cómo afecta a las distribuciones.</h2>", unsafe_allow_html=True)
    st.text("<h2 style='text-align: center;'>Seleccione <strong>Guardar</strong> para ver o descargar aquí las simulaciones deseadas.</h2>", unsafe_allow_html=True)
